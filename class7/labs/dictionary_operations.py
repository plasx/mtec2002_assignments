...
person = {"eye_color":"brown","firstname":"daniel","lastname":"rivera","favorite_food":"pizza","number_of_teeth":"50"}
...
print "%s has %s teeth" % (person['firstname'], person['number_of_teeth'])	
# change your favorite food
person['favorite_food'] = 'pizza rolls with chedder'
